...
class ChartConstraintSolver {
    ...
    addMapping(attrs, parentAttrs, attr, info, mapping, rowContext, rowIndex) {
        var _a, _b;
        if (rowContext == null &&
        ...
        switch (mapping.type) {
            ...
            case specification_1.MappingType.expressionScale:
                {
                    const dataTable = this.manager.dataset.tables.filter((tb) => tb.type === "Main");
                    const dataImageIndex = (_a = dataTable === null || dataTable === void 0 ? void 0 : dataTable[0]) === null || _a === void 0 ? void 0 : _a.rows[rowIndex[0]][common_1.ImageKeyColumn];
                    const imageTable = this.manager.dataset.tables.filter((tb) => tb.type === "Image");
                    const imageDataTableIndex = (_b = imageTable === null || imageTable === void 0 ? void 0 : imageTable[0]) === null || _b === void 0 ? void 0 : _b.rows.find((row) => row[common_1.ImageKeyColumn] == dataImageIndex);
                    // get table from scale mapping
                    const scaleMapping = (mapping);
                    const tableContext = this.manager.dataflow.getTable(scaleMapping.table);
                    rowContext = tableContext.getGroupedContext(rowIndex);
                    // const expr = this.expressionCache.parse(scaleMapping.expression);
                    ...
                    const value = scaleClass.mapDataToAttribute(imageDataTableIndex[common_1.ImageKeyColumn]);
                    attrs[attr] = value;
                }
                break;
            case specification_1.MappingType.text:
                {
                    ...
                    if (expr.parts.find((part) => part.expression instanceof expression_1.FunctionCall &&
    ...
    addObject(object, objectState, parentState, rowContext, solve, rowIndex) {
    ...
    addMark(layout, mark, rowContext, markState, element, elementState, rowIndex) {
    ...
    addGlyph(layout, rowContext, glyph, glyphState, rowIndex) {
        // Mark attributes
