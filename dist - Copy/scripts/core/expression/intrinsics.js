...
function quantile(q, list) {
    ...
    values.sort((a, b) => a - b);
    const pos = (values.length - 1) * q, base = Math.floor(pos), rest = pos - base;
...
exports.functions.quantile = (q, list) => quantile(q, list);
exports.functions.quartile1 = (...list) => quantile(0.25, list);
exports.functions.quartile3 = (...list) => quantile(0.75, list);
exports.functions.iqr = (...list) => quantile(0.75, list) - quantile(0.25, list);
// General operators
...
exports.functions.columnName = (columns, ...names) => {
