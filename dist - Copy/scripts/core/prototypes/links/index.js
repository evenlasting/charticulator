...
exports.registerClasses = exports.TableLinksClass = exports.LayoutsLinksClass = exports.SeriesLinksClass = exports.LinksClass = exports.facetRows = exports.linkMarkTypes = void 0;
...
class LinksClass extends chart_element_1.ChartElementClass {
    ...
    getAttributePanelWidgets(manager) {
        ...
        const widgets = [
            manager.inputSelect({ property: "interpolationType" }, {
                type: "dropdown",
                showLabel: true,
        ...
        if (props.interpolationType == "bezier") {
            widgets.push(manager.inputNumber({ property: "curveness" }, {
                showSlider: true,
                minimum: 0,
                sliderRange: [0, 500],
        ...
        widgets.push(manager.sectionHeader(strings_1.strings.objects.style));
        widgets.push(manager.mappingEditor(strings_1.strings.objects.color, "color", {
            table: props.linkTable && props.linkTable.table,
        }));
        // if (props.linkType == "line") {
        widgets.push(manager.mappingEditor(strings_1.strings.objects.width, "strokeWidth", {
        ...
        // }
        widgets.push(manager.mappingEditor(strings_1.strings.objects.opacity, "opacity", {
