...
class AttrBuilder {
    ...
    static line() {
        return Object.assign(Object.assign(Object.assign(Object.assign({}, this.number("x1")), this.number("y1")), this.number("x2")), this.number("y2"));
    }
    static point() {
        return Object.assign(Object.assign({}, this.number("x")), this.number("y"));
    }
    static center() {
        return Object.assign(Object.assign({}, this.number("cx")), this.number("cy"));
    }
    static size() {
        return Object.assign(Object.assign({}, this.number("width", true, { defaultRange: [0, 200] })), this.number("height", true, { defaultRange: [0, 200] }));
    }
    static dXdY() {
        return Object.assign(Object.assign({}, this.number("dx", true, { defaultRange: [30, 100] })), this.number("dy", true, { defaultRange: [30, 100] }));
    }
    static opacity() {
    ...
    static style(options = {}) {
        const r = Object.assign(Object.assign(Object.assign(Object.assign({}, this.color("stroke", { defaultValue: null })), this.number("strokeWidth", false, {
            defaultRange: [0, 5],
            defaultValue: 1,
