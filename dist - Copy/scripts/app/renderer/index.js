...
exports.GraphicalElementDisplay = exports.renderGraphicalElementSVG = exports.renderTransform = exports.renderSVGPath = exports.renderStyle = exports.renderColor = exports.applyColorFilter = void 0;
...
class TextOnPath extends React.PureComponent {
    ...
    render() {
        return (React.createElement("g", null,
            ...
            React.createElement("text", { style: Object.assign(Object.assign({}, this.props.style), { textAnchor: this.props.align }) },
...
function renderGraphicalElementSVG(element, options) {
    ...
    switch (element.type) {
        ...
        case "path": {
            ...
            return (React.createElement("path", Object.assign({ key: options.key }, mouseEvents, { className: options.className || null, style: style, d: d, transform: path.transform })));
        }
        case "text-on-path": {
            const text = element;
