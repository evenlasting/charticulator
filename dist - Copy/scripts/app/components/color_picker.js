...
exports.ColorPicker = exports.PaletteList = exports.ColorGrid = exports.HCLColorPicker = exports.HSVColorPicker = exports.colorToCSS = void 0;
        ...
        return (React.createElement("div", { className: "color-picker" },
            React.createElement("section", { className: "color-picker-left" },
                ...
                this.props.allowNull ? (React.createElement("div", { className: "color-picker-null" },
                    React.createElement(controls_1.Button, { text: "none", icon: "ChromeClose", onClick: () => {
                            this.setState({
                                currentColor: null,
                            });
