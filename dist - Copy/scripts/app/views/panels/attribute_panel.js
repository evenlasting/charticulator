        ...
        if (selection) {
            ...
            if (selection instanceof stores_1.MarkSelection) {
                ...
                manager.onMapDataHandler = (attribute, data, hints) => {
                    new actions_1.Actions.MapDataToMarkAttribute(glyph, mark, attribute, objectClass.attributes[attribute].type, data.expression, data.valueType, data.metadata, hints, data.table.name).dispatch(this.props.store.dispatcher);
                };
            }
