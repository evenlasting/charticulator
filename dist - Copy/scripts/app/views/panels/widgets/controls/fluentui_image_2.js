...
class ImageUploader extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "charticulator__image-uploader", ref: (e) => (this.refContainer = e), onDragEnter: this.handleDragEnter, onDragLeave: this.handleDragLeave, onDragOver: this.handleDragOver, onDrop: this.handleDrop, style: {
                marginRight: 5,
...
class InputImageProperty extends InputImage {
    render() {
        ...
        return (React.createElement("span", { className: utils_1.classNames("charticulator__widget-control-input-image", ["is-none", isNone], ["is-drag-over", this.state.dragOver]), ref: (e) => (this.element = e), onDragEnter: this.handleDragEnter, onDragLeave: this.handleDragLeave, onDragOver: this.handleDragOver, onDrop: this.handleDrop, style: {
                marginRight: 5,
                marginLeft: 5,
