...
class Button extends React.Component {
    render() {
        return (React.createElement("button", { className: utils_1.classNames("charticulator__widget-control-button", ["is-active", this.props.active], ["has-text", this.props.text != null], ["has-icon", this.props.icon != null], ["is-disabled", this.props.disabled]), title: this.props.title, onClick: (e) => {
