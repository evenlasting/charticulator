...
class InputFormat extends React.Component {
    ...
    doEnter() {
        if (this.props.allowNull && this.refInput.value.trim() == "") {
            ...
            const result = this.props.validate(core_1.replaceTabBySymbol(core_1.replaceNewLineBySymbol(this.refInput.value)));
            if (result.pass) {
                this.setState({
    ...
    render() {
        return (React.createElement("span", { className: "charticulator__widget-control-input-expression" },
            React.createElement("input", { className: utils_1.classNames("charticulator__widget-control-input-expression-input", ["is-error", this.state.errorIndicator]), type: "text", ref: (e) => (this.refInput = e), value: core_1.replaceSymbolByTab(core_1.replaceSymbolByNewLine(this.state.value)), placeholder: this.props.placeholder, onKeyDown: (e) => {
                    if (e.key == "Enter") {
                        this.doEnter();
                    }
                    if (e.key == "Escape") {
...
//# sourceMappingURL=input_format.js.map