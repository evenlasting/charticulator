...
import { InputFontComboboxOptions, InputTextOptions } from "../../../../core/prototypes/controls";
...
export declare class FluentUIWidgetManager implements Prototypes.Controls.WidgetManager, CharticulatorPropertyAccessors {
    ...
    clearButton(property: Prototypes.Controls.Property, icon?: string, isHeader?: boolean): JSX.Element;
