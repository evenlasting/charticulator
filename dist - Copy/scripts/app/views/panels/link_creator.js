...
class LinkCreationPanel extends context_component_1.ContextedComponent {
    ...
    render() {
        return (React.createElement("div", { className: "charticulator__link-type-table" },
            React.createElement("div", { className: "el-row" },
                ...
                React.createElement(radio_control_1.PanelRadioControl, { options: ["line", "band"], icons: ["link/line", "link/band"], labels: ["Line", "Band"], value: this.state.linkType, onChange: (newValue) => this.setState({ linkType: newValue }), showText: true })),
            ...
            this.state.selectedPlotSegments.length == 1 &&
                ...
                React.createElement(radio_control_1.PanelRadioControl, { options: ["link-through", "link-table"], icons: ["link/through", "link/table"], labels: ["Sequentially", "By Link Data"], value: this.state.linkMode, onChange: (newValue) => this.setState({ linkMode: newValue }), showText: true, asList: true }))) : null,
            ...
            React.createElement("div", { className: "el-row" },
                React.createElement(react_1.PrimaryButton, { text: "Create Links", onClick: () => {
    ...
    getDefaultAnchor(manager, linkMode, cs, glyph1, glyphState1, 
    // eslint-disable-next-line
    glyph2, glyphState2) {
    ...
    getLinkObject() {
        ...
        switch (this.state.linkMode) {
            case "link-through": {
                ...
                const { linkType, interpolationType, anchor1, anchor2, color, opacity, } = this.getDefaultAnchor(manager, "link-through", plotSegmentClass.getCoordinateSystem(), glyph, rowToMarkState.get(facets[0][0].join(",")), glyph, rowToMarkState.get(facets[0][1] ? facets[0][1].join(",") : facets[0][0].join(",")));
                const links = {
                    _id: core_1.uniqueID(),
