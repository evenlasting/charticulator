...
class EditingLink extends React.Component {
    ...
    componentDidMount() {
        ...
        this.hammer.on("tap panend", (e) => {
            ...
            if (markInfo) {
                const anchor = markInfo.anchor.points.map((pt) => {
                    return {
            ...
            case "links.table":
                {
                    ...
                    const rowItem = linkTable.rows.find((row) => row.source_id &&
                    ...
                    if (rowItem) {
                        // eslint-disable-next-line
                        const [iRow0, i0] = tables[0].id2RowGlyphIndex.get((_a = rowItem.source_id) === null || _a === void 0 ? void 0 : _a.toString());
                        // eslint-disable-next-line
                        const [iRow1, i1] = tables[1].id2RowGlyphIndex.get((_b = rowItem.target_id) === null || _b === void 0 ? void 0 : _b.toString());
                        glyphs = [
                            {
                                glyph: glyphObjects[0],
