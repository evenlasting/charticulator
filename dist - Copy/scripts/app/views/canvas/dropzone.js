    ...
    renderElement(z) {
        switch (z.type) {
            ...
            case "arc": {
                ...
                const p1 = core_1.Geometry.vectorAdd(zcenter, core_1.Geometry.vectorRotate({ x: zradius + 5, y: 0 }, core_1.Geometry.degreesToRadians(-angleCenter + 1 + 90)));
                const p2 = core_1.Geometry.vectorAdd(zcenter, core_1.Geometry.vectorRotate({ x: zradius + 5, y: 0 }, core_1.Geometry.degreesToRadians(-angleCenter - 1 + 90)));
                return (React.createElement("g", null,
