...
class CreatingComponent extends React.Component {
    ...
    render() {
        return (React.createElement("g", { className: "creating-component" },
            ...
            this.renderHint(),
            React.createElement("rect", { className: "interaction-handler", style: { cursor: "crosshair" }, ref: "handler", x: 0, y: 0, width: this.props.width, height: this.props.height, onMouseEnter: () => {
                    const move = (e) => {
