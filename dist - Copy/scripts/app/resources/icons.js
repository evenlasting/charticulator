...
exports.getSVGIcon = exports.addSVGIcon = void 0;
// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT license.
const iconRegistry = new Map();
function addSVGIcon(path, svgDataURL) {
...
addSVGIcon("general/more-horizontal", require("resources/icons/icons_more-horizontal.svg"));
addSVGIcon("general/more-vertical", require("resources/icons/icons_more-vertical.svg"));
...
addSVGIcon("general/triangle-up", require("resources/icons/icons_triangle-up.svg"));
addSVGIcon("general/triangle-down", require("resources/icons/icons_triangle-down.svg"));
addSVGIcon("general/triangle-left", require("resources/icons/icons_triangle-left.svg"));
addSVGIcon("general/triangle-right-bottom", require("resources/icons/icons_triangle-right-bottom.svg"));
addSVGIcon("general/triangle-right", require("resources/icons/icons_triangle-right.svg"));
addSVGIcon("general/text-size-up", require("resources/icons/icons_text-size-up.svg"));
addSVGIcon("general/text-size-down", require("resources/icons/icons_text-size-down.svg"));
addSVGIcon("general/digits-more", require("resources/icons/icons_digits-more.svg"));
addSVGIcon("general/digits-less", require("resources/icons/icons_digits-less.svg"));
// Toolbar icons
...
addSVGIcon("toolbar/save-changes", require("resources/icons/icons_toolbar-save-has-changes.svg"));
addSVGIcon("toolbar/copy", require("resources/icons/icons_toolbar-copy.svg"));
addSVGIcon("toolbar/download", require("resources/icons/icons_toolbar-download.svg"));
addSVGIcon("toolbar/export-template", require("resources/icons/icons_toolbar-export-template.svg"));
addSVGIcon("toolbar/export", require("resources/icons/icons_toolbar-export.svg"));
...
addSVGIcon("toolbar/import", require("resources/icons/icons_toolbar-import.svg"));
addSVGIcon("toolbar/import-template", require("resources/icons/icons_toolbar-import-template.svg"));
...
// Scaffold icons
addSVGIcon("scaffold/cartesian-x", require("resources/icons/icons_scaffold-xline.svg"));
addSVGIcon("scaffold/cartesian-y", require("resources/icons/icons_scaffold-yline.svg"));
addSVGIcon("scaffold/circle", require("resources/icons/icons_scaffold-circle.svg"));
addSVGIcon("scaffold/curve", require("resources/icons/icons_scaffold-curve.svg"));
addSVGIcon("scaffold/spiral", require("resources/icons/icons_scaffold-spiral.svg"));
addSVGIcon("GripperBarHorizontal", require("resources/icons/icons_scaffold-xwrap.svg"));
addSVGIcon("GripperBarVertical", require("resources/icons/icons_scaffold-ywrap.svg"));
...
// Plot segment icons
addSVGIcon("plot-segment/cartesian", require("resources/icons/icons_plot-segment-cartesian.svg"));
addSVGIcon("plot-segment/polar", require("resources/icons/icons_plot-segment-polar.svg"));
addSVGIcon("plot-segment/line", require("resources/icons/icons_plot-segment-line.svg"));
addSVGIcon("plot-segment/curve", require("resources/icons/icons_plot-segment-curve.svg"));
// Guide icons
...
addSVGIcon("guide/coordinator-x", require("resources/icons/icons_guide-coordinator-x.svg"));
addSVGIcon("guide/coordinator-y", require("resources/icons/icons_guide-coordinator-y.svg"));
addSVGIcon("guide/coordinator-polar", require("resources/icons/icons_guide-coordinator-polar.svg"));
// Link icons
...
addSVGIcon("TriangleShape", require("resources/icons/icons_element-triangle.svg"));
...
addSVGIcon("BarChartVerticalFilter", require("resources/icons/icons_nested-chart.svg"));
...
addSVGIcon("HorizontalDistributeCenter", require("resources/icons/icons_sublayout-dodge-horizontal.svg"));
addSVGIcon("VerticalDistributeCenter", require("resources/icons/icons_sublayout-dodge-vertical.svg"));
addSVGIcon("CharticulatorArrangePolar", require("resources/icons/icons_sublayout-dodge-angular.svg"));
addSVGIcon("CharticulatorStackRadial", require("resources/icons/icons_sublayout-dodge-radial.svg"));
addSVGIcon("GridViewSmall", require("resources/icons/icons_sublayout-grid.svg"));
addSVGIcon("sublayout/polar-grid", require("resources/icons/icons_sublayout-polar-grid.svg"));
addSVGIcon("sublayout/packing", require("resources/icons/icons_sublayout-packing.svg"));
addSVGIcon("sublayout/jitter", require("resources/icons/icons_sublayout-jitter.svg"));
addSVGIcon("align/left", require("resources/icons/icons_align-left.svg"));
addSVGIcon("AlignHorizontalLeft", require("resources/icons/icons_align-left.svg"));
addSVGIcon("AlignHorizontalCenter", require("resources/icons/icons_align-x-middle.svg"));
addSVGIcon("AlignHorizontalRight", require("resources/icons/icons_align-right.svg"));
addSVGIcon("AlignVerticalTop", require("resources/icons/icons_align-top.svg"));
addSVGIcon("AlignVerticalCenter", require("resources/icons/icons_align-y-middle.svg"));
addSVGIcon("AlignVerticalBottom", require("resources/icons/icons_align-bottom.svg"));
addSVGIcon("text-align/left", require("resources/icons/icons_text-align-left.svg"));
addSVGIcon("text-align/x-middle", require("resources/icons/icons_text-align-x-middle.svg"));
addSVGIcon("text-align/right", require("resources/icons/icons_text-align-right.svg"));
addSVGIcon("text-align/top", require("resources/icons/icons_text-align-top.svg"));
addSVGIcon("text-align/y-middle", require("resources/icons/icons_text-align-y-middle.svg"));
addSVGIcon("text-align/bottom", require("resources/icons/icons_text-align-bottom.svg"));
// Data type icons
addSVGIcon("type/boolean", require("resources/icons/icons_type-boolean.svg"));
addSVGIcon("type/categorical", require("resources/icons/icons_type-categorical.svg"));
addSVGIcon("type/numerical", require("resources/icons/icons_type-numerical.svg"));
...
// Checkbox
addSVGIcon("checkbox/empty", require("resources/icons/icons_checkbox-empty.svg"));
addSVGIcon("checkbox/checked", require("resources/icons/icons_checkbox-checked.svg"));
