...
class ChartComponent extends React.Component {
    ...
    convertGlyphEventHandler(handler) {
        ...
        return (element, event) => {
            ...
            handler({ table: (_a = element.plotSegment) === null || _a === void 0 ? void 0 : _a.table, rowIndices }, modifiers);
        };
    }
    render() {
        ...
        const inner = (React.createElement("g", { transform: `translate(${this.props.width / 2}, ${this.props.height / 2})` },
